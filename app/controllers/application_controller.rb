class ApplicationController < ActionController::API
  ...
  def retrieve_direct_message
    ...
    @t_direct_messages = TDirectMessage.select("name, directmsg, t_direct_messages.id as id, t_direct_messages.created_at as created_at, t_direct_messages.draft_message_status as draft_message_status, t_direct_messages.send_user_id as send_user_id,                                                ARRAY_AGG(t_direct_message_files.file) as file_urls, 
  ...
  def retrieve_direct_thread(direct_message_id)
    ...
    @t_direct_threads = TDirectThread.select("name, directthreadmsg, t_direct_threads.id as id, t_direct_threads.created_at as created_at, t_direct_threads.m_user_id, t_direct_threads.draft_message_status, ARRAY_AGG(t_direct_thread_msg_files.file) as file_urls")
  ...
  def retrieve_group_message
    ...
    @t_group_messages = TGroupMessage.select("name, groupmsg, t_group_messages.id as id, t_group_messages.created_at as created_at, 
                                              t_group_messages.m_user_id as send_user_id, t_group_messages.draft_message_status as draft_message_status, ARRAY_AGG(t_group_msg_files.file) as file_urls,
  ...
  def retrieve_group_thread
    ...
    @t_group_threads = TGroupThread.select("name, groupthreadmsg, t_group_threads.id as id, t_group_threads.created_at as created_at, 
                                            t_group_threads.m_user_id as send_user_id, t_group_threads.draft_message_status as draft_message_status, ARRAY_AGG(t_group_thread_msg_files.file) as file_url")
