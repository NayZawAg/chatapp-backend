...
ActiveRecord::Schema[7.1].define(version: 2024_02_13_044650) do
  ...
  create_table "t_direct_messages", force: :cascade do |t|
    t.string "directmsg"
  ...
  create_table "t_direct_star_msgs", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_direct_star_threads", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_direct_threads", force: :cascade do |t|
  ...
  create_table "t_group_mention_msgs", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_group_mention_threads", force: :cascade do |t|
    t.integer "userid"
  ...
  create_table "t_group_messages", force: :cascade do |t|
    t.string "groupmsg"
  ...
  create_table "t_group_star_msgs", force: :cascade do |t|
    t.integer "userid"
    t.integer "groupmsgid"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "t_group_star_threads", force: :cascade do |t|
    t.integer "userid"
    t.integer "groupthreadid"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "t_group_threads", force: :cascade do |t|
  ...
  create_table "t_user_channels", force: :cascade do |t|
  ...
  create_table "t_user_workspaces", force: :cascade do |t|
    t.integer "userid"
